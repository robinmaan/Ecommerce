...
async function getData(){
    const query = `*[_type == 'product'][0...3] | order(_created_AT desc){
        _id,
          price,
        name,
          "slug": slug.current,
        ...
        <div className="bg-white">
            <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
                <div className="flex justify-between items-center">
                    ...
                    <Link className="text-primary flex items-center gap-x-1  " href="/all" > See All{" "}
                    ...
                    {data.map((product)=>(
                     <div key={product._id}   className="group relative">
                        ...
                        key={product._id}>              
                            ...
                            alt="Product Image" src={product.imageUrl} height={300} width={300} />
                        </div>
